...
2. Place [EyeTrackVRResonite.dll](https://github.com/Nytra/EyeTrackVRResonite/releases) into your `rml_mods` folder. This folder should be at `C:\Program Files (x86)\Steam\steamapps\common\Resonite\rml_mods` on windows or `$HOME/.steam/steam/steamapps/common/Resonite/rml_mods` on linux for a default installation. You can create it if it's missing, or if you launch the game once with ResoniteModLoader installed it will create the folder for you.
3. Place [OscCore.dll](https://github.com/Nytra/EyeTrackVRResonite/releases) into 'rml_libs' This folder should be at `C:\Program Files (x86)\Steam\steamapps\common\Resonite\rml_libs` on windows or `$HOME/.steam/steam/steamapps/common/Resonite/rml_libs` on linux for a default installation.
